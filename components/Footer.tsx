  ...
  return (
    <footer className="text-gray-600 mt-12 fixed bottom-0 left-0 bg-white w-full">
      <div className="container mx-auto flex items-center flex-col sm:flex-row py-8">
        <Link href="/">
          <div className="flex justify-center items-center md:justify-start text-gray-900">
            <Image src="/logo.png" alt="Next JS Logo" width={40} height={35} />
            <span className="ml-3 text-md">Coders&apos;s Blog</span>
          </div>
        </Link>
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          © 2022 Coder&apos;s blog —
          <a
            href="https://www.youtube.com/watch?v=JEwokvSQK4o"
